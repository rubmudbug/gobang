...
<div class="userlist">
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <a href="/?room_id=1/?count=1"">房间一</a>
            <span class="badge count"></span>
            <ul class="dropdown-menu client_list">
            </ul>
        </li>
        <li class="list-group-item">
            <a href="/?room_id=2/?count=1">房间二</a>
            <span class="badge count"></span>
            <ul class="dropdown-menu client_list">
            </ul>
        </li>
        <li class="list-group-item">
            <a href="/?room_id=3/?count=1"">房间三</a>
            <span class="badge count"></span>
            <ul class="dropdown-menu client_list">
        ...
        <li class="list-group-item">
            <a href="/?room_id=4/?count=1"">房间四</a>
            <span class="badge count"></span>
            <ul class="dropdown-menu client_list">
        ...
        <li class="list-group-item">
            <a href="/?room_id=5/?count=1"">房间五</a>
            <span class="badge"><?php echo isset($_GET['count'])&&intval($_GET['count'])>0 ? intval($_GET['count']):0;?></span>
            <ul class="dropdown-menu client_list">
            </ul>
        </li>
    </ul>
